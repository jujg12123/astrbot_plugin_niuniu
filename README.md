...
本插件不是原创，是我fork过来的，原作者地址为https://github.com/zgojin/astrbot_plugin_niuniu
原作者的插件有些问题，我这个给他改好了。
...
### 4.7.3
- 补全“牛牛菜单”信息不全的问题，修复群内“比划比划”以及“我的牛牛”指令在群内不显示的问题。
### 4.7.4
- 加入原作者的群友签到系统（https://github.com/zgojin/astrbot_plugin_Qsign），并将信息改为纯文本显示，签到所获得的金币可以用于购买群友，以及牛牛商店中的物品。
### 4.7.5
- 加入银行利息系统，输入查询银行可以了解到当前利率，预计收入等，输入 领取利息 可领取金币到玩家背包现金中。
## 四、更新计划 
